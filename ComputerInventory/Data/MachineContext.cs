    ...
    class MachineContext : DbContext
    {
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            modelBuilder.Entity<Machine>(entity =>
            {
                ...
                entity.Property(e => e.GeneralRole).IsRequired()
                                                    .HasMaxLength(25)
                                                    .IsUnicode(false);
                entity.Property(e => e.InstalledRoles).IsRequired()
                                                    .HasMaxLength(50)
                                                    .IsUnicode(false);
            ...
            modelBuilder.Entity<SupportLog>(entity =>
            {
                ...
                entity.Property(e => e.SupportLogUpdatedBy).IsRequired()
                                                           .HasMaxLength(50)
                                                           .IsUnicode(false);
            ...
            modelBuilder.Entity<SupportTicket>(entity =>
            {
                ...
                entity.Property(e => e.MachineId).HasColumnName("MachineID");
                entity.Property(e => e.TicketOpenedBy).IsRequired()
                                                      .HasMaxLength(50)
                                                      .IsUnicode(false);
            ...
            modelBuilder.Entity<WarrantyProvider>(entity =>
            {
                ...
                entity.Property(e => e.ProviderName).IsRequired()
                                                    .HasMaxLength(50)
                                                    .IsUnicode(false);
                entity.Property(e => e.SupportNumber).IsRequired()
                                                     .HasMaxLength(10)
                                                     .IsUnicode(false);
            });
        }
