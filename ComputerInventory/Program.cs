    ...
    class Program
    {
        ...
        static void DataModificationMenu()
        {
            ...
            do
            {
                ...
                Console.WriteLine("4. Delete All Operating Systems");
                Console.WriteLine("5. Seed table with Operating Systems");
                Console.WriteLine("9. Exit Menu");
                cki = Console.ReadKey();
                try
                {
        ...
        static void DeleteAllOSs()
        {
            using (var context = new MachineContext())
            {
                var os = (from o in context.OperatingSys select o);
